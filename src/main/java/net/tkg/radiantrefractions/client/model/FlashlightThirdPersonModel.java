...
public class FlashlightThirdPersonModel extends GeoModel<FlashlightItem> {
    @Override
    public ResourceLocation getModelResource(FlashlightItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(RadiantRefractionsMod.MODID, "geo/thirdperson_flashlight.geo.json");
    }
